...
export default function Marker({map, markerData, selectCafe, selectedCafe, neighborhoodFunction, selectedCafes}) {
    ...
    useEffect(() => {
        ...
        const marker = new maptilersdk.Marker({color: color, scale: scale})
